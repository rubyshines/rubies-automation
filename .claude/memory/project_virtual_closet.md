...
- New arrangement `linkOnly(ctx)`, chosen when `centre.mode === 'link'` regardless of `?lead`. No nav links. Sections, in order:
  ...
  2. Headline and one sentence: "Shop 20% off RUBIES, support [Centre]." then "A quarter of your order goes to [Centre]'s Virtual Closet, and RUBIES matches it." Button "Shop with 20% off" → `/[slug]/shop`. No fine print, no size guide link, no brand paragraph under it (Jamie, 2026-09-21).
  ...
  4. Sponsor row: heading "Not shopping? Sponsor the closet. Help someone feel comfortable and confident.", four tiles → `/[slug]/sponsor/[key]`. Nothing under them.
