...
- Conflicts resolved (2026-07-17): all 27 topics ruled by Jamie → 12 ruling-facts loaded to kb_candidates, advisor fact #22 softened (primarily USPS), Skipping Stone partner address fixed in registry + republished to site, returns pages verified clean. Open: 3PL customs-invoice answer; free-swimwear age-limit site edit (Jamie); Friendships page update or unpublish (Jamie); minor — whether the original order's shipping fee is refunded on exchange (asked once, unanswered).
- Unpublished facts triaged (2026-07-17, per Jamie: "use your own reasoning and tools"): 230 → 46 look-up-able dropped / 153 tool-verified auto-accepted (loaded, trust=reply_corpus; 165 reply-corpus candidates total) / 31 to Jamie (republished as the New Facts tab). Triage rule now permanent in kb-mining-protocol.md. Facts review complete (2026-07-17): 31 calls interpreted → 18 loaded (discretion-gated ones marked FOUNDER DISCRETION inline), 13 dropped/handled (MOASH never a partner; ValidUSA address update is Jamie's separate task; boundary-size dup of conflict ruling). 195 reply-corpus candidates total. Voice rules decided (2026-07-17, blank=agree convention): 17 adopted (6 modified incl. urgency-gated executive decisions, first-order-full-only retention line, our-for-facilities possessives), 3 rejected (empathy-sorry, signature warming, radical transparency). All 17 folded into the advisor prompt; pinned scenarios noApologyForThirdParty + retentionLineGating added (3/3 green incl. noApologyForFit). Step 3 phase 1 FULLY REVIEWED. Phase 2 complete (2026-07-17/18): batches 16-62 (the hand-written Gorgias year, Feb 2025 - Jan 2026 — NOT advisor era; advisor went live Feb 2026, the 2025 volume jump was the Tidio→Gorgias migration) mined by 47 subagents → 1,930 assertions → consolidated vs settled corpus + Jamie's rulings (218 known / 55 superseded / 39 survivors) → triage auto-loaded 30, Jamie ruled the final 8 in chat (exchange shipping capped at 3 per order — amended into the free-exchange candidates; Serena has the gusset with shorts-construction nuance; back-pulling = too small confirmed; Friendships paused — page candidate flagged stale; discretionary price adjustment; birthday AJs + anniversary pins are email flows separate from 300 loyalty points; roster year-round rule). ALL 65 batches now mined — corpus fully harvested through 2026-07-10; only the incremental post-export tail remains for the future refresh cron.
- Steps 4+5 code shipped (PR #97): `rebuildKnowledgeBase.js` (candidates → cs_knowledge_base with source_url/trust columns + Voyage embeddings, idempotent; --retire-legacy backs up + deletes the stale 63 articles) and weekly `refreshKb.js` wired as a Monday-gated daily-sync-all step (re-harvest, propagate amendments, flag drifted sources for re-extraction). LIVE 2026-07-18: migration applied, 292 articles rebuilt + embedded, semantic search verified against founder rulings, 64 legacy articles backed up (temp-analysis-data/kb-legacy-backup-2026-07-18.json) and retired; subsumed parked item closed. Step 6 (advisor search tool) stays gated until after 2026-07-23. Related ship: apologies fault-scoped in advisor prompt (PR #81 + pinned scenario), quantified by voice analysis (16/262 fit apologies in 2026 era).
