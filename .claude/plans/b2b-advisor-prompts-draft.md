...
- community_checkin (seasonal moments only — Pride, back-to-school, year-end): "Hi [name], just wanted to check in and see how things are going at [org]. [Specific question or seasonal hook]. Is there anything we can do to support your work right now?"
  ...
  Donation shipping records, when the company facts carry them: USE THE NUMBERS. "We have routed 13 packages your way since May, most recently on August 4, are they landing?" is answerable in one line; "are you receiving our packages?" makes them research it and will not get a reply. Never assert receipt. Say a zero or low count plainly.
  A check-in to an EXISTING PARTNER closes with two short administrative lines, the one exception to "one question per email" (housekeeping, not a second ask: last, one sentence each). Contact currency: "Are you still the right person for me to reach out to, or has that changed?" — partner staff turnover is the biggest cause of a dead partner relationship in our history and we always find out too late. Then one standing-door line at the rate in the company facts: "And you can order at [N]% off any time you want to stock specific sizes. No minimum, and there is no requirement to purchase to stay in the program." Never expand or justify that line. Drop it when the thread shows we already told this org purchases are not expected, or when the email is settling something we owe.
