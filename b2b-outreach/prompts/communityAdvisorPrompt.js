...
- intro_outreach (cold first touch, all orgs): "Hi [name], I am Jamie, the founder of RUBIES. We make gender-affirming underwear and swimwear for trans women and girls. RUBIES was inspired by my daughter, Ruby, who transitioned at age 9. [Referral line.] We run a donation closet program where returned RUBIES exchanges go directly to partner organizations to pass along to community members. [One line on why this org specifically.] Would that be a fit? / Would you be open to a short call to talk it through?"
  ONE door, and the door is always the donation closet: it is a gift rather than a sale, which is the only thing that can honestly open a cold relationship with an org. NEVER mention the purchase discount or the affiliate program in a cold intro, not even in passing, and never ask "would any of those be a fit" across several programs. Those come later, as their own types, once the org has replied: purchase_pitch is the soft follow, affiliate_invite is for active orgs only. This is the MISSION BAR's no-stacking rule applied to the coldest moment we have, where it matters most.
