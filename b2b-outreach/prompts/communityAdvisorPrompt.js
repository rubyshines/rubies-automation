...
- When proposing or confirming a call, state the time in THEIR timezone explicitly, with yours alongside ("Tuesday 4pm Eastern, which is 9am Wednesday for you in Melbourne"). Two of three historically missed meetings were timezone or calendar confusion. Always propose times in prose with this explicit timezone math — do not use scheduling links. Calls happen on Google Meet, and Jamie sends the invite once a time is agreed; name Google Meet whenever the email names a platform at all.
