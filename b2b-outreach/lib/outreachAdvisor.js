...
const OUTPUT_SCHEMA = {
  ...
  properties: {
    ...
    facts_to_verify: { type: 'array', items: { type: 'string' }, description: 'Facts you stated from context that an operator should verify before sending (inventory, pricing specifics, dates).' },
